...
type _OnCloseCallback = Callable[[BaseConnection, Exception], None]
type _OnOpenCallback = Callable[[BaseConnection], None]
type _OnOpenErrorCallback = Callable[[BaseConnection, str | Exception], None]
