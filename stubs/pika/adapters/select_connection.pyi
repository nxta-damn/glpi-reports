...
type _OnCloseCallback = Callable[[base_connection.BaseConnection, Exception], None]
type _OnOpenCallback = Callable[[base_connection.BaseConnection], None]
type _OnOpenErrorCallback = Callable[
    [base_connection.BaseConnection, str | Exception], None
]
...
class SelectConnection(base_connection.BaseConnection["IOLoop"]):
    def __init__(
        ...
        custom_ioloop: Optional[IOLoop | nbio_interface.AbstractIOServices,] = ...,
