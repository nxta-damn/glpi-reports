...
class BlockingChannel:
    def __init__(
        self, channel_impl: channel.Channel, connection: BlockingConnection
    ) -> None: ...
    ...
    def add_on_cancel_callback(
        self, callback: Callable[[spec.Basic.Cancel], None]
    ) -> None: ...
    def add_on_return_callback(
        self, callback: Callable[[spec.Basic.Return], None]
    ) -> None: ...
    def basic_consume(
        self,
        queue: Any,
    ...
    ) -> list[tuple[spec.Basic.Deliver, spec.BasicProperties, bytes],]: ...
    ...
    def basic_reject(
        self, delivery_tag: int | None = ..., requeue: bool = ...
    ) -> None: ...
    ...
    def queue_declare(
        ...
        exclusive: bool = ...,
        auto_delete: bool = ...,
        arguments: spec.Queue.DeclareOk | None = ...,
